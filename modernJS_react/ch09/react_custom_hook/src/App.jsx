...
import { useFetchUsers } from "./hooks/useFetchUsers";          //  <- 다른 컴포넌트에서 처리할 때 필요한 부분

export const App = () => {
    //사용자 정의 훅 사용
    //함수를 실행하고 반환값을 분할 대입해서 전달
    //const {userList, onClickFetchUser} = useFetchUsers();
    const {userList, isLoading, isError, onClickFetchUser} = useFetchUsers();   //  <- 다른 컴포넌트에서 처리할 때 필요한 부분
